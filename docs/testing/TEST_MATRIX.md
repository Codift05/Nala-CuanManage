...
| Transaction | validator/idempotency | form dan state | CRUD, saldo, replay, concurrency | integer rupiah/pagination | IDOR/mass assignment | catat sampai dashboard | partial |
...
| Receipt/OCR | parser/schema | picker/review/error | AI timeout dan draft | confidence per field | payload/prompt injection | scan-koreksi-simpan | planned |
