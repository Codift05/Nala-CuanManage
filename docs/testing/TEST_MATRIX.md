...
| AI Coach | redaction, delimiter, schema | chat/draft/fallback | timeout dan konfirmasi | structured output | injection corpus, PII, rate limit | saran-konfirmasi | partial |
